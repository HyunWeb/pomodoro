...
- **나의 역할**:  
    - **프로젝트 팀장**: 일정 조율 및 전체 구조 기획  
    - **프론트엔드 개발**: 일정 관리, 타이머, 마이페이지 기능 구현  
    - **백엔드 설계**: DB 설계 및 API 개발  
    - **디자인 설계**: Figma를 활용한 UI/UX 기획 및 프로토타입 제작
...
### 💻 프론트엔드 개발  
- **일정 관리 기능**: 달력 기반 일정 추가/삭제/수정 기능 개발  
- **타이머 기능**: 뽀모도로 타이머 및 일반 타이머 구현  
